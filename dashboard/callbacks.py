...
from layouts import ue_level_report_layout, cell_level_report_layout, gnodb_level_report_layout, network_level_report_layout, main_layout
...
def register_callbacks(app):
    ...
    def toggle_modal(n_clicks, username, password):
        if n_clicks and check_credentials(username, password):
            return False, {}  # Display main layout
        return True, {'display': 'none'}  # Keep main layout hidden
