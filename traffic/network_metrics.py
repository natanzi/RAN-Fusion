...
def calculate_ue_throughput(ue, network_load_impact):
    # Assuming ue.data_size represents the amount of data generated by the UE in bytes
    # and ue.interval represents the time interval in seconds over which the data is sent
